...
# Создаем объект кофеварки
my_coffee_maker = CoffeeMaker("Moulinex", "Subito", 1.5)

# Используем методы, унаследованные от базового класса
my_coffee_maker.turn_on()  # Output: Moulinex Subito is now on.
my_coffee_maker.make_coffee()  # Output: Moulinex Subito is making coffee.
my_coffee_maker.turn_off()  # Output: Moulinex Subito is now off.
